...
type Notice struct {
	NoticeStartTime time.Time `orm:"column(notice_start_time);type(datetime)" json:"notice_start_time"`
	NoticeEndTime   time.Time `orm:"column(notice_end_time);type(datetime)" json:"notice_end_time"`
	NoticeType      int       `orm:"column(notice_type)" json:"notice_type"`
	NoticeStatus    int       `orm:"column(notice_status)" json:"notice_status"`
	NoticeContent   string    `orm:"column(notice_content);null" json:"notice_content"`
	NoticeVersion   int       `orm:"column(notice_version)" json:"notice_version"`
	CreateTime      time.Time `orm:"column(create_time);type(datetime)" json:"notice_create_time"`
