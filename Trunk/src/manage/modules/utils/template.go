...
func i18nFormatKeyHTML(lang, format string, args ...interface{}) template.HTML {
	s := fmt.Sprintf(format, args...)
	return template.HTML(i18n.Tr(lang, s))
}
...
func init() {
	...
	beego.AddFuncMap("i18nformatkey", i18nFormatKeyHTML)
