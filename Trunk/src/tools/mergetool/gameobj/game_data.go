...
func (g *GameData) Load(ar *utils.LoadArchive) {
...
func (g *GameData) LoadAttr(ar *utils.LoadArchive, attrcount int32) {
...
func (g *GameData) LoadRecord(ar *utils.LoadArchive, reccount int32) {
...
func (g *GameData) Store(ar *utils.StoreArchive) error {
...
func (g *GameData) StoreAttr(ar *utils.StoreArchive) error {
...
func (g *GameData) StoreRecord(ar *utils.StoreArchive) error {
	size := g.Records.Size()
	for i := 0; i < size; i++ {
